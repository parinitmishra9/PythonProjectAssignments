...
# import pickle
# # Define a sample dictionary to be pickled
...
# # Output the result of unpickling
# print("Loaded Data:", loaded_data)
# print("Result of division:", result)
# # Note: The division by zero will raise an exception, so 'result' will not be defined.
...
bad_student = {'roll': 104, 'name': 'Eve', 'percent': 150}
try:
    validate_student(students['student1'])  # valid
    validate_student(bad_student)           # will raise
except InvalidPercentageError as e:
    print("Validation error:", e)
except Exception as e:
    print("Other error during validation:", e)
finally:
